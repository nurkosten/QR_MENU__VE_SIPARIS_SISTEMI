        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HandledByUserId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServiceRequests", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ServiceRequests_AspNetUsers_HandledByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_CategoryId_IsActive_IsAvailable",
                table: "Products",
                columns: new[] { "CategoryId", "IsActive", "IsAvailable" });

            migrationBuilder.CreateIndex(
                name: "IX_Restaurants_PublicToken",
                table: "Restaurants",
                column: "PublicToken",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ServiceRequests_HandledByUserId",
